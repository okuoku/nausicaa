...
dnl enum enum MHD_RequestTerminationCode
...
dnl enum enum MHD_GNUTLS_CipherAlgorithm
...
dnl enum enum MHD_GNUTLS_Protocol
...
dnl enum enum MHD_ConnectionInfoType
...
dnl enum enum MHD_DaemonInfoType
