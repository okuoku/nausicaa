...

(define (curl-numeric-code->symbolic-code numeric-code)
  (let ((symbolic-code (hashtable-ref numeric-error-code-table numeric-code #f)))
    (or symbolic-code (assertion-violation #f "invalid cURL numeric error code" numeric-code))))

(define (curl-symbolic-code->numeric-code symbolic-code)
  (let ((numeric-code (hashtable-ref symbolic-error-code-table symbolic-code #f)))
    (or numeric-code (assertion-violation #f "invalid cURL symbolic error code" symbolic-code))))


(define numeric-error-code-table
...

(define symbolic-error-code-table
