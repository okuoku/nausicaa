...
;;;Contents: foreign library inspection generator for gpg-error
;;;Date:
;;;
;;;Abstract
;;;
...
(define-c-type gpg_error_t		unsigned-int)


;;;; constants

(define-c-enumeration gpg_err_source_t
  "gpg_err_source_t"
...
(define-c-enumeration gpg_err_code_t
  "gpg_err_code_t"
  GPG_ERR_NO_ERROR
  GPG_ERR_GENERAL
