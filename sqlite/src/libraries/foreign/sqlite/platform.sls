...
(define-c-function sqlite3_libversion
  (char* sqlite3_libversion (void)))

(define-c-function sqlite3_sourceid
  (char* sqlite3_sourceid (void)))

(define-c-function sqlite3_libversion_number
  (int sqlite3_libversion_number (void)))

(define-c-function sqlite3_threadsafe
  (int sqlite3_threadsafe (void)))


;;;; initialisation and configuration

(define-c-function sqlite3_initialize
  (int sqlite3_initialize (void)))

(define-c-function sqlite3_shutdown
  (int sqlite3_shutdown (void)))

(define-c-function sqlite3_os_init
  (int sqlite3_os_init (void)))

(define-c-function sqlite3_os_end
  (int sqlite3_os_end (void)))

;; This is a variadic function.
;;
;; (define-c-function sqlite3_config
;;   (int sqlite3_config (int ...)))

(define-c-function sqlite3_extended_result_codes
...
;; This is a variadic function.
;;
;; (define-c-function sqlite3_db_config
;;   (int sqlite3_db_config (sqlite3* int ...)))


;;;; database interaction

(define-c-function sqlite3_open
  (int sqlite3_open (char* sqlite3**)))

(define-c-function sqlite3_open16
  (int sqlite3_open16 (void* sqlite3**)))

(define-c-function sqlite3_open_v2
  (int sqlite3_open_v2 (char* sqlite3** int char*)))

(define-c-function sqlite3_last_insert_rowid
  (sqlite3_int64 sqlite3_last_insert_rowid (sqlite3*)))

(define-c-function sqlite3_changes
  (int sqlite3_changes (sqlite3*)))

(define-c-function sqlite3_total_changes
  (int sqlite3_total_changes (sqlite3*)))

(define-c-function sqlite3_interrupt
  (void sqlite3_interrupt (sqlite3*)))

(define-c-function sqlite3_complete
  (int sqlite3_complete (char*)))

(define-c-function sqlite3_complete16
  (int sqlite3_complete16 (char*)))

(define-c-function sqlite3_busy_handler
  (int sqlite3_busy_handler (sqlite3* callback void*)))

(define-c-function sqlite3_busy_timeout
  (int sqlite3_busy_timeout (sqlite3* int)))

(define-c-function sqlite3_get_table
  (int sqlite3_get_table (sqlite3* char* char*** int* int* char**)))

(define-c-function sqlite3_free_table
  (void sqlite3_free_table (char**)))

(define-c-function sqlite3_progress_handler
  (void sqlite3_progress_handler (sqlite3* int callback void*)))


;;;; SQL stuff

(define-c-function sqlite3_prepare
  (int sqlite3_prepare (sqlite3* char* int sqlite3_stmt** char**)))

(define-c-function sqlite3_prepare_v2
  (int sqlite3_prepare_v2 (sqlite3* char* int sqlite3_stmt** char**)))

(define-c-function sqlite3_prepare16
  (int sqlite3_prepare16 (sqlite3* void* int sqlite3_stmt** void**)))

(define-c-function sqlite3_prepare16_v2
  (int sqlite3_prepare16_v2 (sqlite3* void* int sqlite3_stmt** void**)))

(define-c-function sqlite3_sql
  (char* sqlite3_sql (sqlite3_stmt*)))

(define-c-function sqlite3_finalize
  (int sqlite3_finalize (sqlite3_stmt*)))

(define-c-function sqlite3_reset
  (int sqlite3_reset (sqlite3_stmt*)))

(define-c-function sqlite3_db_handle
...
(define-c-function sqlite3_bind_parameter_count
  (int sqlite3_bind_parameter_count (sqlite3_stmt*)))

(define-c-function sqlite3_bind_parameter_name
  (char* sqlite3_bind_parameter_name (sqlite3_stmt* int)))

(define-c-function sqlite3_bind_parameter_index
  (int sqlite3_bind_parameter_index (sqlite3_stmt* char*)))

(define-c-function sqlite3_clear_bindings
  (int sqlite3_clear_bindings(sqlite3_stmt*)))

(define-c-function sqlite3_column_count
  (int sqlite3_column_count (sqlite3_stmt*)))

(define-c-function sqlite3_column_name
  (char* sqlite3_column_name (sqlite3_stmt* int)))

(define-c-function sqlite3_column_name16
...
(define-c-function sqlite3_column_decltype
  (char* sqlite3_column_decltype (sqlite3_stmt* int)))

(define-c-function sqlite3_column_decltype16
  (void* sqlite3_column_decltype16 (sqlite3_stmt* int)))

(define-c-function sqlite3_step
  (int sqlite3_step (sqlite3_stmt*)))

(define-c-function sqlite3_data_count
  (int sqlite3_data_count (sqlite3_stmt*)))

;;; --------------------------------------------------------------------

(define-c-function sqlite3_column_blob
  (void* sqlite3_column_blob (sqlite3_stmt* int)))

(define-c-function sqlite3_column_bytes
  (int sqlite3_column_bytes (sqlite3_stmt* int)))

(define-c-function sqlite3_column_bytes16
  (int sqlite3_column_bytes16 (sqlite3_stmt* int)))

(define-c-function sqlite3_column_double
  (double sqlite3_column_double (sqlite3_stmt* int)))

(define-c-function sqlite3_column_int
  (int sqlite3_column_int (sqlite3_stmt* int)))

(define-c-function sqlite3_column_int64
  (sqlite3_int64 sqlite3_column_int64 (sqlite3_stmt* int)))

(define-c-function sqlite3_column_text
  (void* sqlite3_column_text (sqlite3_stmt* int)))

(define-c-function sqlite3_column_text16
  (void* sqlite3_column_text16 (sqlite3_stmt* int)))

(define-c-function sqlite3_column_type
  (int sqlite3_column_type (sqlite3_stmt* int)))

(define-c-function sqlite3_column_value
  (sqlite3_value* sqlite3_column_value (sqlite3_stmt* int)))

;;; --------------------------------------------------------------------

(define-c-function sqlite3_create_function
  (int sqlite3_create_function (sqlite3* char* int int void* callback callback callback)))

(define-c-function sqlite3_create_function16
  (int sqlite3_create_function16 (sqlite3* void* int int void* callback callback callback)))

;;; --------------------------------------------------------------------

(define-c-function sqlite3_value_blob
  (void* sqlite3_value_blob (sqlite3_value*)))

(define-c-function sqlite3_value_bytes
  (int sqlite3_value_bytes (sqlite3_value*)))

(define-c-function sqlite3_value_bytes16
  (int sqlite3_value_bytes16 (sqlite3_value*)))

(define-c-function sqlite3_value_double
  (double sqlite3_value_double (sqlite3_value*)))

(define-c-function sqlite3_value_int
  (int sqlite3_value_int (sqlite3_value*)))

(define-c-function sqlite3_value_int64
  (sqlite3_int64 sqlite3_value_int64 (sqlite3_value*)))

(define-c-function sqlite3_value_text
  (void* sqlite3_value_text (sqlite3_value*)))

(define-c-function sqlite3_value_text16
  (void* sqlite3_value_text16 (sqlite3_value*)))

(define-c-function sqlite3_value_text16le
  (void* sqlite3_value_text16le (sqlite3_value*)))

(define-c-function sqlite3_value_text16be
  (void* sqlite3_value_text16be (sqlite3_value*)))

(define-c-function sqlite3_value_type
  (int sqlite3_value_type (sqlite3_value*)))

(define-c-function sqlite3_value_numeric_type
  (int sqlite3_value_numeric_type (sqlite3_value*)))


;;;; stuff for SQL functions

(define-c-function sqlite3_aggregate_context
  (void* sqlite3_aggregate_context (sqlite3_context* int)))

(define-c-function sqlite3_user_data
  (void* sqlite3_user_data (sqlite3_context*)))

(define-c-function sqlite3_context_db_handle
  (sqlite3* sqlite3_context_db_handle (sqlite3_context*)))


(define-c-function sqlite3_get_auxdata
  (void* sqlite3_get_auxdata (sqlite3_context* int)))

(define-c-function sqlite3_set_auxdata
  (void sqlite3_set_auxdata (sqlite3_context* int void* callback)))

;;; --------------------------------------------------------------------

(define-c-function sqlite3_result_blob
  (void sqlite3_result_blob (sqlite3_context* void* int callback)))

(define-c-function sqlite3_result_double
  (void sqlite3_result_double (sqlite3_context* double)))

(define-c-function sqlite3_result_error
  (void sqlite3_result_error (sqlite3_context* char* int)))

(define-c-function sqlite3_result_error16
  (void sqlite3_result_error16 (sqlite3_context* void* int)))

(define-c-function sqlite3_result_error_toobig
  (void sqlite3_result_error_toobig (sqlite3_context*)))

(define-c-function sqlite3_result_error_nomem
  (void sqlite3_result_error_nomem (sqlite3_context*)))

(define-c-function sqlite3_result_error_code
  (void sqlite3_result_error_code (sqlite3_context* int)))

(define-c-function sqlite3_result_int
  (void sqlite3_result_int (sqlite3_context* int)))

(define-c-function sqlite3_result_int64
  (void sqlite3_result_int64 (sqlite3_context* sqlite3_int64)))

(define-c-function sqlite3_result_null
  (void sqlite3_result_null (sqlite3_context*)))

(define-c-function sqlite3_result_text
  (void sqlite3_result_text (sqlite3_context* char* int callback)))

(define-c-function sqlite3_result_text16
  (void sqlite3_result_text16 (sqlite3_context* void* int callback)))

(define-c-function sqlite3_result_text16le
  (void sqlite3_result_text16le (sqlite3_context* void* int callback)))

(define-c-function sqlite3_result_text16be
  (void sqlite3_result_text16be (sqlite3_context* void* int callback)))

(define-c-function sqlite3_result_value
  (void sqlite3_result_value (sqlite3_context* sqlite3_value*)))

(define-c-function sqlite3_result_zeroblob
  (void sqlite3_result_zeroblob (sqlite3_context* int)))


;;;; collations

(define-c-function sqlite3_create_collation
  (int sqlite3_create_collation (sqlite3* char* int void* callback)))

(define-c-function sqlite3_create_collation_v2
  (int sqlite3_create_collation_v2 (sqlite3* char* int void* callback callback)))

(define-c-function sqlite3_create_collation16
  (int sqlite3_create_collation16 (sqlite3* void* int void* callback)))


(define-c-function sqlite3_collation_needed
  (int sqlite3_collation_needed (sqlite3* void* callback)))

(define-c-function sqlite3_collation_needed16
...
(define-c-function sqlite3_malloc
  (void* sqlite3_malloc (int)))

(define-c-function sqlite3_realloc
  (void* sqlite3_realloc (void* int)))

(define-c-function sqlite3_free
  (void sqlite3_free (void*)))

(define-c-function sqlite3_memory_used
  (sqlite3_int64 sqlite3_memory_used (void)))

(define-c-function sqlite3_memory_highwater
  (sqlite3_int64 sqlite3_memory_highwater (int)))

(define-c-function sqlite3_release_memory
  (int sqlite3_release_memory (int)))


;;;; commit

(define-c-function sqlite3_get_autocommit
  (int sqlite3_get_autocommit (sqlite3*)))


(define-c-function sqlite3_commit_hook
  (void* sqlite3_commit_hook (sqlite3* callback)))

(define-c-function sqlite3_rollback_hook
...
(define-c-function sqlite3_load_extension
  (int sqlite3_load_extension (sqlite3* char* char* char**)))

(define-c-function sqlite3_enable_load_extension
  (int sqlite3_enable_load_extension (sqlite3* int)))

(define-c-function sqlite3_auto_extension
  (int sqlite3_auto_extension (callback)))

(define-c-function sqlite3_reset_auto_extension
  (void sqlite3_reset_auto_extension (void)))


;;;; blobs

(define-c-function sqlite3_blob_open
  (int sqlite3_blob_open (sqlite3* char* char* char* sqlite3_int64 int sqlite3_blob**)))

(define-c-function sqlite3_blob_close
  (int sqlite3_blob_close (sqlite3_blob*)))

(define-c-function sqlite3_blob_bytes
  (int sqlite3_blob_bytes (sqlite3_blob*)))

(define-c-function sqlite3_blob_read
  (int sqlite3_blob_read (sqlite3_blob* void* int int)))

(define-c-function sqlite3_blob_write
  (int sqlite3_blob_write (sqlite3_blob* void* int int)))

;;; --------------------------------------------------------------------

(define-c-function sqlite3_bind_blob
  (int sqlite3_bind_blob (sqlite3_stmt* int void* int callback)))

(define-c-function sqlite3_bind_double
  (int sqlite3_bind_double (sqlite3_stmt* int double)))

(define-c-function sqlite3_bind_int
  (int sqlite3_bind_int (sqlite3_stmt* int int)))

(define-c-function sqlite3_bind_int64
  (int sqlite3_bind_int64 (sqlite3_stmt* int sqlite3_int64)))

(define-c-function sqlite3_bind_null
  (int sqlite3_bind_null (sqlite3_stmt* int)))

(define-c-function sqlite3_bind_text
  (int sqlite3_bind_text (sqlite3_stmt* int char* int callback)))

(define-c-function sqlite3_bind_text16
  (int sqlite3_bind_text16 (sqlite3_stmt* int void* int callback)))

(define-c-function sqlite3_bind_value
  (int sqlite3_bind_value (sqlite3_stmt* int sqlite3_value*)))

(define-c-function sqlite3_bind_zeroblob
  (int sqlite3_bind_zeroblob (sqlite3_stmt* int int)))


;;;; mutexes

(define-c-function sqlite3_mutex_alloc
  (sqlite3_mutex* sqlite3_mutex_alloc (int)))

(define-c-function sqlite3_mutex_free
  (void sqlite3_mutex_free (sqlite3_mutex*)))

(define-c-function sqlite3_mutex_enter
  (void sqlite3_mutex_enter (sqlite3_mutex*)))

(define-c-function sqlite3_mutex_try
...
(define-c-function sqlite3_db_mutex
  (sqlite3_mutex* sqlite3_db_mutex (sqlite3*)))


;;;; online backup

(define-c-function sqlite3_backup_init
  (sqlite3_backup* sqlite3_backup_init (sqlite3* char* sqlite3* char*)))

(define-c-function sqlite3_backup_step
  (int sqlite3_backup_step (sqlite3_backup* int)))

(define-c-function sqlite3_backup_finish
  (int sqlite3_backup_finish (sqlite3_backup*)))

(define-c-function sqlite3_backup_remaining
  (int sqlite3_backup_remaining (sqlite3_backup*)))

(define-c-function sqlite3_backup_pagecount
...
(define-c-function sqlite3_randomness
  (void sqlite3_randomness (int void*)))

(define-c-function sqlite3_set_authorizer
  (int sqlite3_set_authorizer (sqlite3* callback void*)))

(define-c-function sqlite3_trace
  (void* sqlite3_trace (sqlite3* callback void*)))

(define-c-function sqlite3_profile
...
(define-c-function sqlite3_update_hook
  (void* sqlite3_update_hook (sqlite3* callback void*)))

(define-c-function sqlite3_enable_shared_cache
  (int sqlite3_enable_shared_cache (int)))

(define-c-function sqlite3_soft_heap_limit
...
(define-c-function sqlite3_status
  (int sqlite3_status (int int* int* int)))

(define-c-function sqlite3_db_status
...
(define-c-function sqlite3_errcode
  (int sqlite3_errcode (sqlite3*)))

(define-c-function sqlite3_extended_errcode
  (int sqlite3_extended_errcode (sqlite3*)))

(define-c-function sqlite3_errmsg
  (char* sqlite3_errmsg (sqlite3*)))

(define-c-function sqlite3_errmsg16
  (void* sqlite3_errmsg16 (sqlite3*)))

;;; --------------------------------------------------------------------

(define-c-function sqlite3_vfs_find
  (sqlite3_vfs* sqlite3_vfs_find (char*)))

(define-c-function sqlite3_vfs_register
  (int sqlite3_vfs_register (sqlite3_vfs* int)))

(define-c-function sqlite3_vfs_unregister
