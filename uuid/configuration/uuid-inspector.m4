...
NAUSICAA_INSPECT_TYPE([UUID_RC_T],[uuid_rc_t],[unsigned-int],[#f])
NAUSICAA_INSPECT_TYPE([UUID_FMT_T],[uuid_fmt_t],[unsigned-int],[#f])
...
dnl enum UUID make modes
NAUSICAA_ENUM_VALUE([UUID_MAKE_V1])
NAUSICAA_ENUM_VALUE([UUID_MAKE_V3])
NAUSICAA_ENUM_VALUE([UUID_MAKE_V4])
NAUSICAA_ENUM_VALUE([UUID_MAKE_V5])
NAUSICAA_ENUM_VALUE([UUID_MAKE_MC])

dnl enum enum uuid_fmt_t
