...
;;;
;;;TAI and UTC date converters no longer look at leap seconds, which was
;;;an error.
;;;
...
;;;
;;;Moronic,  overly complicated  COPY-TIME procedure  changed  to simple
;;;version suggested by Martin Gasbichler.
;;;
;;;To provide more portability, changed  #\Space to #\space and #\tab to
;;;#\Tab to (integer->char 9)
;;;
;;;Changed arity-3  calls to / and -  to arity 2 calls  (again, for more
;;;general portability).
;;;
;;;split-real  fixed again  --  by removing  it,  and using  'fractional
;;;part'. Will Fitzgerald 5/16/2003.
