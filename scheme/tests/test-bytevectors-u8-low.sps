...
;;; --------------------------------------------------------------------
  ...
  (check
      (guard (exc ((assertion-violation? exc)
		   (condition-who exc)))
	(%bytevector-u8-every "invalid criterion" (S "abc") 0 2))
    => '%bytevector-u8-every)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "aaaa"))
	     (beg 0)
	     (end (bytevector-length str)))
	(%bytevector-u8-every (lambda (byte) (char-alphabetic? (integer->char byte))) str beg end))
    => #t)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (guard (exc ((assertion-violation? exc)
		   (condition-who exc)))
	(%bytevector-u8-any "invalid criterion" (S "abc") 0 2))
    => '%bytevector-u8-any)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "11a11"))
	     (beg 0)
	     (end (bytevector-length str)))
	(%bytevector-u8-any (lambda (byte) (char-alphabetic? (integer->char byte))) str beg end))
    => #t)
...
(parameterise ((check-test-name 'mapping))
  ...
  (check
      (let* ((str (S "aaaa"))
	     (beg 0)
	     (end (bytevector-length str)))
	(%subbytevector-u8-map byte-upcase str beg end))
    => (S "AAAA"))
	 ...
	 (lambda (ch)
	   (set! result
		 (bytevector-u8-append result
				       (number->bytevector-u8 (byte-upcase ch)))))
	 str beg end)
	result)
    => (S "65656565"))
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "AAAbcd")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-trim byte-upper-case? str beg end))
    => (S "bcd"))
...
;;; --------------------------------------------------------------------
  ...
  (check
	...
	(%bytevector-u8-trim-right 97 str beg end))
    => (S "bcd"))
  ...
  (check
      (let* ((str (S "bcdAAA")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-trim-right byte-upper-case? str beg end))
    => (S "bcd"))
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "AAAbcdAAA")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-trim-both byte-upper-case? str beg end))
    => (S "bcd"))
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "aBcd")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-index byte-upper-case? str beg end))
    => 1)

  (check
      (let* ((str (S "aBcd")) (end (bytevector-length str)))
	(%bytevector-u8-index byte-upper-case? str 1 end))
    => 1)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "aBcd")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-index-right byte-upper-case? str beg end))
    => 1)

  (check
      (let* ((str (S "aBcd")) (end (bytevector-length str)))
	(%bytevector-u8-index-right byte-upper-case? str 1 end))
    => 1)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "Bacd")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-skip byte-upper-case? str beg end))
    => 1)

  (check
      (let* ((str (S "Bacd")) (end (bytevector-length str)))
	(%bytevector-u8-skip byte-upper-case? str 1 end))
    => 1)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "acdB")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-skip-right byte-upper-case? str beg end))
    => 2)

  (check
      (let* ((str (S "acdB")) (end (bytevector-length str)))
	(%bytevector-u8-skip-right byte-upper-case? str 1 end))
    => 2)
...
;;; --------------------------------------------------------------------
  ...
  (check
	...
	(%bytevector-u8-count byte-upper-case? str beg end))
    => 2)

  (check
      (let* ((str (S "aBcd")) (end (bytevector-length str)))
	(%bytevector-u8-count byte-upper-case? str 1 end))
    => 1)
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "aBcBd")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-delete byte-upper-case? str beg end))
    => (S "acd"))
...
;;; --------------------------------------------------------------------
  ...
  (check
      (let* ((str (S "aBcBd")) (beg 0) (end (bytevector-length str)))
	(%bytevector-u8-filter byte-upper-case? str beg end))
    => (S "BB"))
