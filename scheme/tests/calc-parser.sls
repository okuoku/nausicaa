  ...
  (define (make-calc-parser)
    (lr-driver
      ...
      (vector
        ...
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($1 (vector-ref ___stack (- ___sp 1)))) (___reduce-pop-and-push 1 1 $1)))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
        ...
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($2 (vector-ref ___stack (- ___sp 1))) ($1 (vector-ref ___stack (- ___sp 3))))
            (___reduce-pop-and-push 2 3 $1)))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($2 (vector-ref ___stack (- ___sp 1))) ($1 (vector-ref ___stack (- ___sp 3))))
            (___reduce-pop-and-push 2 3 $1)))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* () (___reduce-pop-and-push 2 3 #f)))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 4 (begin (hashtable-set! (table-of-variables) $1 $3) #f))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 5 (+ $1 $3))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
        ...
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 5 (div $1 $3))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 5 (mod $1 $3))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 5 (expt $1 $3))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
        ...
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($1 (vector-ref ___stack (- ___sp 1))))
            (___reduce-pop-and-push 1 5 (hashtable-ref (table-of-variables) $1 #f))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($4 (vector-ref ___stack (- ___sp 1)))
                 ($3 (vector-ref ___stack (- ___sp 3)))
                 ($2 (vector-ref ___stack (- ___sp 5)))
                 ($1 (vector-ref ___stack (- ___sp 7))))
            (___reduce-pop-and-push 4 5 (apply (eval $1 (environment '(rnrs))) $3))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($1 (vector-ref ___stack (- ___sp 1)))) (___reduce-pop-and-push 1 5 $1)))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 5 $2)))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* () (___reduce-pop-and-push 0 6 '())))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($2 (vector-ref ___stack (- ___sp 1))) ($1 (vector-ref ___stack (- ___sp 3))))
            (___reduce-pop-and-push 2 6 (cons $1 $2))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* (($3 (vector-ref ___stack (- ___sp 1)))
                 ($2 (vector-ref ___stack (- ___sp 3)))
                 ($1 (vector-ref ___stack (- ___sp 5))))
            (___reduce-pop-and-push 3 7 (cons $2 $3))))
        (lambda (___stack ___sp ___reduce-pop-and-push yypushback yycustom)
          (let* () (___reduce-pop-and-push 0 7 '())))))))