...
(parameterise ((check-test-name	'range-inspection))
  ...
  (check (range-strict-subset? (make-range 40 60) (make-range 50 60)) => #t) ; same last, start <
  (check (range-strict-subset? (make-range 50 60) (make-range 40 60)) => #f) ; same last, start >
  (check (range-strict-subset? (make-range 40 50) (make-range 40 60)) => #f) ; same start, last <
  (check (range-strict-subset? (make-range 40 60) (make-range 40 50)) => #t) ; same start, last >
  ...
  (check (range-strict-subset? (make-range 10 20) (make-range 20 30)) => #f) ; overlapping, last=start
  (check (range-strict-subset? (make-range 20 30) (make-range 10 20)) => #f) ; overlapping, start=past
  (check (range-strict-subset? (make-range 10 20) (make-range 21 30)) => #f) ; contiguous <
  (check (range-strict-subset? (make-range 21 30) (make-range 10 20)) => #f) ; contiguous >
...
;;; --------------------------------------------------------------------
  ...
  (check (domain-strict-subset? (make-domain '(10 . 20))
				(make-domain '(21 . 30))) => #f) ; contiguous <
  (check (domain-strict-subset? (make-domain '(21 . 30))
				(make-domain '(10 . 20))) => #f) ; contiguous >
