...
;; End:
   ...
   (vector
    ...
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
           		(parse-escaped-char yytext #\x7 yyline yycolumn)
        ))
    #t
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
           		(parse-escaped-char yytext #\x8 yyline yycolumn)
        ))
    #t
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
           		(parse-escaped-char yytext #\x9 yyline yycolumn)
;;Newline is special for SILex.
    ...
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
           		(parse-escaped-char yytext #\xB yyline yycolumn)
        ))
    #t
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
           		(parse-escaped-char yytext #\xC yyline yycolumn)
        ))
    #t
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
           		(parse-escaped-char yytext #\xD yyline yycolumn)
        ))
    #t
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
                     	(parse-escaped-char yytext #\x22 yyline yycolumn)
        ))
    #t
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
                   	(parse-escaped-char yytext #\x5C yyline yycolumn)
        ))
    #f
    (lambda (yycontinue yygetc yyungetc)
    ...
    (lambda (yycontinue yygetc yyungetc)
      (lambda (yytext yyline yycolumn yyoffset)
			  ...
			  (if (or (<= 0 num #xD7FF) (<= #xE000 num #x10FFFF))
			      (make-tok char-tok yytext yyline yycolumn (integer->char num))
