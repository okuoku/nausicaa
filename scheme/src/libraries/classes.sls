...
(define-syntax define-class
  (syntax-rules (fields mutable immutable parent protocol sealed opaque parent-rtd nongenerative
    ...
    ((_ (?name ?constructor ?predicate) ?spec ...)
     (%define-class/sort-specs
    ...
    ((_ ?name ?spec ...)
     (%define-class/expand-name ?name ?spec ...))))
...
(define-syntax %define-class/sort-specs
  ...
  (syntax-rules (fields mutable immutable parent protocol sealed opaque parent-rtd nongenerative
			fields-accessor)
    ((%define-class/sort-specs
      (?name ...) (?collected-mutable-field ...) (?collected-immutable-field ...)
      (fields		?fie ...)	(parent			?par ...)
      (protocol		?pro ...)	(sealed			?sea ...)
      (opaque		?opa ...)	(parent-rtd		?pad ...)
      (nongenerative	?non ...)	(fields-accessor	?fac ...)
      (parent ?parent-name) ?spec ...)
     (%define-class/sort-specs
      (?name ...) (?collected-mutable-field ...) (?collected-immutable-field ...)
      (fields		?fie ...)	(parent			?par ... ?parent-name)
      (protocol	?pro ...)		(sealed			?sea ...)
      (opaque		?opa ...)	(parent-rtd		?pad ...)
      (nongenerative	?non ...)	(fields-accessor	?fac ...)
      ?spec ...))

    ((%define-class/sort-specs (?name ...)
    ...
    ((%define-class/sort-specs (?name ...)
     ...
     (%define-class/sort-specs (?name ...)
			       ...
			       (?collected-immutable-field ...)
			       (fields		?fie ...)	(parent			?par ...)
			       (protocol	?pro ...)	(sealed			?sea ... ?sealed)
			       (opaque		?opa ...)	(parent-rtd		?pad ...)
			       (nongenerative	?non ...)	(fields-accessor	?fac ...)
			       ?spec ...))
    ...
    ((%define-class/sort-specs (?name ...)
     ...
     (%define-class/sort-specs (?name ...)
			       ...
			       (fields		?fie ...)	(parent		?par ...)
			       (protocol	?pro ...)	(sealed		?sea ...)
			       (opaque		?opa ... ?opaque)	(parent-rtd	?pad ...)
			       (nongenerative	?non ...)	(fields-accessor	?fac ...)
			       ?spec ...))
    ...
    ((%define-class/sort-specs (?name ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...)
			       (parent-rtd ?parent-rtd ?parent-cd) ?spec ...)
     (%define-class/sort-specs (?name ...)
			       (?collected-mutable-field ...)
			       (?collected-immutable-field ...)
			       (fields		?fie ...)
    ...
    ((%define-class/sort-specs (?name ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...)
			       (nongenerative ?nongenerative) ?spec ...)
     (%define-class/sort-specs (?name ...)
			       (?collected-mutable-field ...)
			       (?collected-immutable-field ...)
			       (fields		?fie ...)
    ...
    ((%define-class/sort-specs (?name ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...)
			       (fields (mutable ?field0 ?field ...) ?field-spec ...) ?spec ...)
     (%define-class/sort-specs (?name ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...)
			       (fields ?field-spec ...) ?spec ...))

    ;;Collect immutable field.
    ((%define-class/sort-specs (?name ...)
			       (?collected-mutable-field ...)
			       (?collected-immutable-field ...)
			       (fields		?fie ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...)
			       (fields (immutable ?field0 ?field ...) ?field-spec ...) ?spec ...)
     (%define-class/sort-specs (?name ...)
			       (?collected-mutable-field ...)
    ...
    ;;Collect immutable field declared without IMMUTABLE auxiliary syntax.
    ((%define-class/sort-specs (?name ...)
			       (?collected-mutable-field ...)
			       (?collected-immutable-field ...)
			       (fields		?fie ...)
    ...
    ((%define-class/sort-specs (?name ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...)
			       (fields-accessor ?fields-accessor) ?spec ...)
     (%define-class/sort-specs (?name ...)
			       (?collected-mutable-field ...)
			       (?collected-immutable-field ...)
			       (fields		?fie ...)
    ...
    ((%define-class/sort-specs (?name ...)
			       ...
			       (nongenerative	?non ...)
			       (fields-accessor	?fac ...))
     (%define-class/filter-unused (?name ...)
				  () ;collected specs
				  (?collected-mutable-field ...)
				  (?collected-immutable-field ...)
				  (fields		?fie ...)
...
(define-syntax %define-class/filter-unused
  ...
  (lambda (stx)
    (syntax-case stx (fields parent protocol sealed opaque parent-rtd nongenerative)
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    (?collected-mutable-field ...) (?collected-immutable-field ...)
				    (fields)
				    ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ...)
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    ...
				    (fields ?e0 ?e ...)
				    ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (fields ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    ...
				    (parent ?e0 ?e ...)
				    ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (parent ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    ...
				    (protocol ?e0 ?e ...)
				    ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (protocol ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    (?collected-mutable-field ...) (?collected-immutable-field ...)
				    (sealed ?e0 ?e ...) ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (sealed ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    (?collected-mutable-field ...) (?collected-immutable-field ...)
				    (opaque) ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ...) (?collected-mutable-field ...)
				      (?collected-immutable-field ...) ?spec ...))
      ;;Collect used OPAQUE form.
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    (?collected-mutable-field ...) (?collected-immutable-field ...)
				    (opaque ?e0 ?e ...) ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (opaque ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    (?collected-mutable-field ...) (?collected-immutable-field ...)
				    (parent-rtd ?e0 ?e ...) ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (parent-rtd ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    (?collected-mutable-field ...) (?collected-immutable-field ...)
				    (nongenerative #t) ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (nongenerative))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    ...
				    (nongenerative ?e0 ?e ...)
				    ?spec ...)
       #'(%define-class/filter-unused (?name ...) (?collected-spec ... (nongenerative ?e0 ?e ...))
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
      ...
      ((%define-class/filter-unused (?name ...) (?collected-spec ...)
				    ...
				    ?spec ...)
       #'(%define-class/filter-unused (?accessor-name ?name ...) (?collected-spec ...)
				      (?collected-mutable-field ...) (?collected-immutable-field ...)
				      ?spec ...))
	 ...
	 (with-syntax ((ACCESSOR (datum->syntax #'?name (%accessor (syntax->datum #'?name)))))
      ...
      ((%define-class/filter-unused (?accessor-name ?name ?constructor ?predicate)
				    ...
				    (?collected-mutable-field ...) (?collected-immutable-field ...))
       #'(begin
	   (define-record-type (?name ?constructor ?predicate) ?collected-spec ...)
...
(define-syntax %define-class/expand-field-names
  (lambda (stx)
    ...
    (syntax-case stx ()
      ...
      ;;NOTE: mutable field specs  either have both accessor and mutator
      ;;or have none; they cannot have only the accessor.

      ;;Expand mutable field spec with neither accessor nor mutator names.
	 ...
	 (with-syntax ((ACCESSOR (datum->syntax #'?name (%accessor name field)))
      ...
      ;;Pass through mutable field spec with accessor and mutator name.
      ((_ ?name ?accessor-name
	  (?expanded-mutable-field ...)
	  (?expanded-immutable-field ...)
      ...
      ;;Expand immutable field spec without accessor name.
      ((_ ?name ?accessor-name
	  (?expanded-mutable-field ...)
	  (?expanded-immutable-field ...)
	  ()	;no more mutable field specs
	 ...
	 (with-syntax ((ACCESSOR (datum->syntax #'?name (%accessor name field))))
      ...
      ;;Pass through immutable field spec with accessor name.
      ((_ ?name ?accessor-name
	  (?expanded-mutable-field ...)
	  (?expanded-immutable-field ...)
	  ()	;no more mutable field specs
	  ...
	  (?expanded-immutable-field ...)
	  ()	;no more mutable field specs
	  ())	;no more immutable field specs
       #'(define-syntax ?accessor-name
	   (syntax-rules ()
	     ((_  ?name ?body0 ?body (... ...))
	      (%with-record-field ?name
				  (?expanded-mutable-field ... ?expanded-immutable-field ...)
				  ?body0 ?body (... ...))))))
      )))

(define-syntax %with-record-field
  (lambda (stx)
    (define (%field name field)
      (string->symbol (string-append (symbol->string name) "." (symbol->string field))))
    (syntax-case stx ()

      ;;Process a field spec with both accessor and mutator.
      ((_ ?name ((?field ?accessor ?mutator) ?spec ...) ?body0 ?body ...)
       (with-syntax ((FIELD (datum->syntax #'?name (%field (syntax->datum #'?name)
							   (syntax->datum #'?field)))))
	 #'(with-accessor-and-mutator ((FIELD ?name ?accessor ?mutator))
				      (%with-record-field ?name (?spec ...) ?body0 ?body ...))))

      ;;Process a field spec with accessor only.
      ((_ ?name ((?field ?accessor) ?spec ...) ?body0 ?body ...)
       (with-syntax ((FIELD (datum->syntax #'?name (%field (syntax->datum #'?name)
							   (syntax->datum #'?field)))))
	 #'(with-accessor-and-mutator ((FIELD ?name ?accessor))
				      (%with-record-field ?name (?spec ...) ?body0 ?body ...))))

      ;;No more field specs, output the body.
      ((_ ?name () ?body0 ?body ...)
       #'(begin ?body0 ?body ...))
      )))
...
(define-syntax with-fields
  (syntax-rules ()
    ...
    ((_ ((?with-class ?name) ?spec ...) ?body0 ?body ...)
     (?with-class ?name (with-fields (?spec ...) ?body0 ?body ...)))
