    ...
    (lr-driver
      '#(((*default* . *error*) (ID . 5) (NUM . 4)
         ...
         ((*default* . *error*) (*eoi* . 24)
           (QUESTION-ID . 23) (ADD . 22) (SUB . 21)
           (MUL . 20) (DIV . 19) (DIV0 . 18) (MOD . 17)
           (EXPT . 16) (LT . 15) (GT . 14) (LE . 13)
           (GE . 12) (EQ . 11))
         ((*default* . -15) (EQ . 11) (GE . 12) (LE . 13)
           (GT . 14) (LT . 15) (EXPT . 16) (MOD . 17)
           (DIV0 . 18) (DIV . 19) (MUL . 20))
         ((*default* . -14))
         ((*default* . *error*) (QUESTION-ID . 23)
           (RPAREN . 25) (ADD . 22) (SUB . 21) (MUL . 20)
           (DIV . 19) (DIV0 . 18) (MOD . 17) (EXPT . 16)
           (LT . 15) (GT . 14) (LE . 13) (GE . 12) (EQ . 11))
         ((*default* . -21) (SUB . 1) (ADD . 2) (LPAREN . 3)
           (NUM . 4) (ID . 5))
         ((*default* . *error*) (ID . 5) (NUM . 4)
           (LPAREN . 3) (ADD . 2) (SUB . 1))
         ((*default* . *error*) (ID . 5) (NUM . 4)
         ...
         ((*default* . -24) (EQ . 11) (GE . 12) (LE . 13)
           (GT . 14) (LT . 15) (EXPT . 16) (MOD . 17)
           (DIV0 . 18) (DIV . 19) (MUL . 20) (SUB . 21)
           (ADD . 22) (COMMA . 42) (QUESTION-ID . 23))
         ((*default* . -13)) ((*default* . -12))
         ((*default* . -11)) ((*default* . -10))
         ((*default* . -9))
         ((*default* . -8) (EQ . 11) (GE . 12) (LE . 13)
           (GT . 14) (LT . 15))
         ...
         ((*default* . -2) (EQ . 11) (GE . 12) (LE . 13)
           ...
           (DIV0 . 18) (DIV . 19) (MUL . 20))
         ((*default* . *error*) (QUESTION-ID . 23)
           (COLON-ID . 44) (ADD . 22) (SUB . 21) (MUL . 20)
           (DIV . 19) (DIV0 . 18) (MOD . 17) (EXPT . 16)
           (LT . 15) (GT . 14) (LE . 13) (GE . 12) (EQ . 11))
         ((*default* . -17))
         ((*default* . *error*) (ID . 5) (NUM . 4)
         ...
         ((*default* . -24) (EQ . 11) (GE . 12) (LE . 13)
           ...
           (DIV0 . 18) (DIV . 19) (MUL . 20) (SUB . 21)
           (ADD . 22) (COMMA . 42) (QUESTION-ID . 23))
         ((*default* . -18) (EQ . 11) (GE . 12) (LE . 13)
           (GT . 14) (LT . 15) (EXPT . 16) (MOD . 17)
           (DIV0 . 18) (DIV . 19) (MUL . 20) (SUB . 21)
           (ADD . 22) (QUESTION-ID . 23))
         ((*default* . -23)))
      ...
      (vector '()
        ...
        (lambda
          ...
          (yy-reduce-pop-and-push 5 1 (list 'if $1 $3 $5)
            yy-stack-states yy-stack-values))
        (lambda
          (yy-reduce-pop-and-push yypushback yycustom
           yy-stack-states $1 . yy-stack-values)
        ...
        (lambda
          (yy-reduce-pop-and-push yypushback yycustom
           yy-stack-states $3 $2 $1 . yy-stack-values)
          (yy-reduce-pop-and-push 3 3 (cons $2 $3)
            yy-stack-states yy-stack-values))
        (lambda
          (yy-reduce-pop-and-push yypushback yycustom
           yy-stack-states . yy-stack-values)
