...

  (import (for (except (rnrs)
    ...
    (for (nausicaa language cond-expand)		expand run)
    (for (only (nausicaa language assertions) assert)	expand run)
    (for (nausicaa language conditions)			expand run)
    (for (nausicaa language extensions)			expand run)
    (for (nausicaa language parameters)			expand run)
