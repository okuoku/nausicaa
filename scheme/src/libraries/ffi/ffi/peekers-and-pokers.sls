...
(library (foreign ffi peekers-and-pokers)
  (export
    ...
    (rename (pointer-ref-c-signed-char		peek-signed-char)
	    ...
	    (pointer-ref-c-size_t		peek-size_t)
	    (pointer-ref-c-ssize_t		peek-ssize_t)
	    ...
	    (pointer-set-c-size_t!		poke-size_t!)
	    (pointer-set-c-ssize_t!		poke-ssize_t!)
	    ...
	    (array-ref-c-size_t			peek-array-size_t)
	    (array-ref-c-ssize_t		peek-array-ssize_t)
	    ...
	    (array-set-c-size_t!		poke-array-size_t!)
	    (array-set-c-ssize_t!		poke-array-ssize_t!)
...
(let-syntax ((define-signed-array-peeker (syntax-rules ()
  ...
  (define-signed-array-peeker array-ref-c-ssize_t		sizeof-ssize_t))
...
(let-syntax ((define-unsigned-array-peeker (syntax-rules ()
  ...
  (define-unsigned-array-peeker array-ref-c-size_t		sizeof-size_t))
...
(let-syntax ((define-signed-array-poker (syntax-rules ()
  ...
  (define-signed-array-poker array-set-c-ssize_t!		sizeof-ssize_t))
...
(let-syntax ((define-unsigned-array-poker (syntax-rules ()
  ...
  (define-unsigned-array-poker array-set-c-size_t!		sizeof-size_t))
...
(let-syntax ((define-signed-array-pointer-getter (syntax-rules ()
  ...
  (define-signed-array-pointer-getter array-ptr-c-ssize_t		sizeof-ssize_t))
...
(let-syntax ((define-unsigned-array-pointer-getter (syntax-rules ()
  ...
  (define-unsigned-array-pointer-getter array-ptr-c-size_t		sizeof-size_t))
