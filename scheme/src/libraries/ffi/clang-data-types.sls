...
(define (clang-external-type->clang-internal-type type)
  (case type
    ...
    ((ssize_t)					(quote signed-int))
    ((intptr_t)					(quote signed-int))
    ((uint unsigned unsigned-int)		'unsigned-int)
    ((size_t)					(quote unsigned-int))
    ((uintptr_t)				(quote unsigned-int))
    ...
    ((void)					'void)
    (else
     (assertion-violation #f "C language data type unknown to Nausicaa" type))))
