...
;;;Contents: lists of bindings of R6RS libraries
;;;Date: Thu Apr  8, 2010
;;;
;;;Abstract
;;;
...

(define rnrs-sorting-6
  '(list-sort vector-sort vector-sort!))


(define rnrs-control-6
  '(when unless do case-lambda))


(define rnrs-records-syntactic-6
  '( ;;
    define-record-type
    record-type-descriptor
    record-constructor-descriptor
...

(define rnrs-records-procedural-6
  '( ;;
    make-record-type-descriptor
    record-type-descriptor?
    make-record-constructor-descriptor
...

(define rnrs-records-inspection-6
  '( ;;
    record?
    record-rtd
    record-type-name
...

(define rnrs-exceptions-6
  '(with-exception-handler guard raise raise-continuable))


(define rnrs-conditions-6
  '( ;;
    &condition
    condition simple-conditions condition?
    condition-predicate condition-accessor
...

(define rnrs-arithmetic-fixnums-6
  '( ;;
    fixnum?
    fixnum-width
    least-fixnum
...

(define rnrs-arithmetic-flonums-6
  '( ;;
    flonum?
    real->flonum
    fl=?
...

(define rnrs-arithmetic-bitwise-6
  '( ;;
    bitwise-not
    bitwise-and
    bitwise-ior
