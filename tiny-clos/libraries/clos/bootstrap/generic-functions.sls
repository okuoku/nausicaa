...
(library (clos bootstrap generic-functions)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   ...
		   'procedure
		   (lambda (%generic %next-methods entity-class)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   ...
		   'procedure
		   (lambda (%generic %next-methods object init-args)
		     object)))
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <class>)
		   'procedure
		   (lambda (%generic %next-methods class-inst init-args)
		     ;; call-next-method, the hard way ...
		     ((car %next-methods) %generic (cdr %next-methods)
		      class-inst init-args)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   ...
		   'procedure
		   (lambda (%generic %next-methods generic-inst init-args)
		     ;; call-next-method, the hard way ...
		     ((car %next-methods) %generic (cdr %next-methods)
		      generic-inst init-args)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   ...
		   'procedure
		   (lambda (%generic %next-methods method-inst init-args)
		     ;; call-next-method, the hard way ...
		     ((car %next-methods) %generic (cdr %next-methods)
		      method-inst init-args)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <class>)
		   'procedure
		   (lambda (%generic %next-methods class)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <class>)
		   'procedure
		   (lambda (%generic %next-methods class slot allocator)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <generic>)
		   'procedure
		   (lambda (%generic %next-methods entity method)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <generic>)
		   'procedure
		   (lambda (%generic %next-methods generic)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <generic>)
		   'procedure
		   (lambda (%generic %next-methods generic args)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <generic>)
		   'procedure
		   (lambda (%generic %next-methods generic methods)
  ...
  (bootstrap-add-method
   ...
   (bootstrap-make <method>
		   'specializers (list <object>)
		   'procedure
		   (lambda (%generic %next-methods object port)
